...
#. Go to *Invoicing/Accounting > Configuration > Settings > Invoicing*
#. In the *Customer Payments* section, check *Block Invoice Risk* for validate
   invoice limit is exceeded.
