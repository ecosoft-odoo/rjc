odoo.define('l10n_th_asset_register_report.l10n_th_asset_register_report_widget', function
(require) {
    'use strict';
    ...
    var accountFinancialReportWidget = Widget.extend({
        events: {
            'click .o_l10n_th_asset_register_reports_web_action':
                'boundLink',
            'click .o_l10n_th_asset_register_reports_web_action_multi':
                'boundLinkmulti',
            'click .o_l10n_th_asset_register_reports_web_action_monetary':
                'boundLinkMonetary',
            'click .o_l10n_th_asset_register_reports_web_action_monetary_multi':
